...
def train(
    ...
    model = CAE(input_shape=input_shape, classes=gen_train.classes, num_feature=num_feature, transfer_learning=transfer_learning, tlmodel_path=tlmodel_path)
    ...
    #plot_model(model, to_file=save_direc + '/dcec_model.png', show_shapes=True)
    model.summary()
